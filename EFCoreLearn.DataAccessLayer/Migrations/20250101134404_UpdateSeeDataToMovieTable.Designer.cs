...
namespace EFCoreLearn.DataAccessLayer.Migrations
{
    ...
    [Migration("20250101134404_UpdateSeeDataToMovieTable")]
    partial class UpdateSeeDataToMovieTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EFCoreLearn.Models.Models.Movie", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            MovieId = 1L,
                            ActionDate = new DateTime(2025, 1, 1, 19, 29, 4, 357, DateTimeKind.Local).AddTicks(5458),
                            ActionTaken = 1,
                            ActionType = "Create",
                        ...
                        {
                            MovieId = 4L,
                            ActionDate = new DateTime(2025, 1, 1, 19, 29, 4, 357, DateTimeKind.Local).AddTicks(5501),
                            ActionTaken = 2,
                            ActionType = "Create",
                            Genre = "Comedy, Action",
                            MovieName = "Dhammal",
